...
<head>
	...
	<link rel="stylesheet" href="/login/animate.min.css">

	<link rel="stylesheet" href="/login/font-awesome.min.css">
	<link rel="stylesheet" href="/login/style.min.css">
	<link rel="stylesheet" href="/login/iconfont.css">

	<link rel="stylesheet" href="/login/sweetalert/sweetalert.css">
	...
	<script type="text/javascript" src="/login/host.js"></script>
	<script type="text/javascript" src="/login/sweetalert/sweetalert.min.js"></script>
